    ...
    <div className="animate-in fade-in duration-500">
      ...
      <div className="w-full px-4 py-8">
        <form onSubmit={handleSubmit} className="space-y-6 pb-20">
          ...
          <section><FormLabel required>Vị trí: Ghi tên cao trình + vị trí ( ví dụ: ct 292 phía hạ lưu van đĩa h6)</FormLabel><input type="text" className="w-full p-2.5 rounded border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 text-[13px] outline-none" required value={formData.location} onChange={(e) => setFormData({...formData, location: e.target.value})} /></section>
